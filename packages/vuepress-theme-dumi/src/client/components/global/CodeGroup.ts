...
export default defineComponent({
  ...
  setup(_, { slots }) {
    ...
    const tabRefs = ref<HTMLButtonElement[]>([]) as Ref<HTMLButtonElement[]>;
    ...
    return () => {
      ...
      return h('div', { class: 'theme-code-group' }, [
        h(
          'div',
          { class: 'code-theme-code-group__nav' },
          h(
            'ul',
            { class: 'theme-code-group__ul' },
            items.map((vnode, i) => {
              const isActive = i === activeIndex.value;

              return h(
                'li',
                { class: 'theme-code-group__li', key: vnode.props.title },
                h(
                  'button',
                  {
                    ref: (element) => {
                    ...
                    class: {
                      'theme-code-group__nav-tab': true,
                      'theme-code-group__nav-tab-active': isActive,
                    },
